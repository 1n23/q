...
void Altona2::Main()
{
  sRunApp(new App,sScreenMode(sSM_Fullscreen*0,"dynamic vertices, using mapping",1280,720));
}
...
void App::OnInit()
{
  ...
  Geo->SetVertex(sResBufferPara(sRBM_Vertex|sRU_MapWrite,sizeof(sVertexPT),vc),0);
